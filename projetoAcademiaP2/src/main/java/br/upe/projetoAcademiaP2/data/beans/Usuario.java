...
public abstract class Usuario {
    ...
    public Double getPercGorduraAtual() {
        return percGorduraAtual;
    }

    public void setPercGorduraAtual(Double percGorduraAtual) {
        this.percGorduraAtual = percGorduraAtual;
    }

    public List<PlanoTreino> getPlanTreinos() {
        return planTreinos;
    }

    public void setPlanTreinos(List<PlanoTreino> planTreinos) {
        this.planTreinos = planTreinos;
    }

    public List<IndicadorBiomedico> getIndicaBio() {
        return indicaBio;
    }

    public void setIndicaBio(List<IndicadorBiomedico> indicaBio) {
        this.indicaBio = indicaBio;
    }
}
